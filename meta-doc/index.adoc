...
Example:
----
It is detailed in xref:../getting-started/index.adoc[Getting Started]
----

that produces:
====
It is detailed in lxref:../getting-started/index.adoc[Getting Started]
====

=== Programs

Programs should be formatted following the xref:../programming-style/index.adoc[JaCaMo programming style for source code]. Source code should be included into the AsciiDoc files as follows:
