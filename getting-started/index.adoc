...
As you can see, an agent named `sample_agent` has printed a "Hello World" message. The agent however keeps running, even without having anything to do. To stop the execution,  you can press <CTRL>-C. 
