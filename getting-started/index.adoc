...
image:./img/screen-mind2.png[Bob's Mind]

Now you can also inspect the environment state at http://127.0.0.1:3273:

image:./img/screen-env1.png[Env State]
...
.my1st_app.jcm
----
include::code/my1st-app/my1st_app.jcm
...
image:./img/screen-org1.png[Org State]

The organisation provides several information for the agents to consider:

image:./img/screen-mind3.png[Bob's Mind]
