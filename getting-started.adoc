...
The following commands will create a new JaCaMo application with some initial code for agents,  environment and organisation. You will be asked to give an identification to the application, here we will use `my1st-app`.
